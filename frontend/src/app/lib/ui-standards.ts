...
export const UI_PATTERNS: UiPatternDefinition[] = [
    ...
    },
    {
        ...
        summary: 'POPUP/MODAL COM LOGO NO CABECALHO, NOME TECNICO EXCLUSIVO E BLOCO "TELA:" ISOLADO EM LINHA PROPRIA NO RODAPE COM BOTAO DE COPIA E ABERTURA DA LOGICA/SQL DA TELA. TODA TELA NOVA DEVE TER UM UNICO NOME TECNICO VISIVEL E EXCLUSIVO.',
