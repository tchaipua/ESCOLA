...
export default function ResponsaveisPage() {
    ...
    const fetchGuardians = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/guardians`, { headers: { } });
            if (!response.ok) {
        ...
        <div className="flex h-[calc(100vh-4.5rem)] min-h-0 w-full pt-0">
            <div className="flex w-full flex-col bg-transparent">
                <PrincipalProgramHeader
                    ...
                    description="Gerencie pais, mães e demais responsáveis vinculados aos alunos e seus acessos no sistema."
