...
const SCREEN_ORIGIN_RULES: ScreenOriginRule[] = [
  ...
  { screenId: 'MSINFOR_ADMIN_CONFIGURACOES_GERAIS_MODAL', match: 'exact', physicalPath: escolaAppPath('msinfor-admin', 'page.tsx') },
  { screenId: 'POPUP_MSINFOR_ADMIN_ALTERAR_EMAIL_VINCULO', match: 'exact', physicalPath: escolaAppPath('msinfor-admin', 'page.tsx') },
  { screenId: 'MSINFOR_ADMIN_FILIAIS_ESCOLA', match: 'exact', physicalPath: escolaAppPath('msinfor-admin', 'page.tsx') },
  { screenId: 'MSINFOR_ADMIN_EDITAR_FILIAL_ESCOLA', match: 'exact', physicalPath: escolaAppPath('msinfor-admin', 'page.tsx') },
  { screenId: 'ACESSOS_ESPECIAIS_GESTAO_ESCOLA', match: 'prefix', physicalPath: escolaAppPath('msinfor-admin', 'page.tsx') },
  ...
  { screenId: 'PRINCIPAL_FINANCEIRO_MSINFOR_CONFIGURACAO_RECIBOS', match: 'exact', systemName: 'Sistema Financeiro', physicalPath: financeiroAppPath('msinfor', 'configuracao-recibos', 'page.tsx') },
  { screenId: 'PRINCIPAL_FINANCEIRO_MSINFOR_CONFIGURA_RECIBOS_IMAGEM', match: 'exact', systemName: 'Sistema Financeiro', physicalPath: financeiroAppPath('msinfor', 'configura-recibos-imagem', 'page.tsx') },
  { screenId: 'PRINCIPAL_FINANCEIRO_MSINFOR_MODELOS_IMPRESSAO', match: 'exact', systemName: 'Sistema Financeiro', physicalPath: financeiroAppPath('msinfor', 'modelos-impressao', 'page.tsx') },
...
- GET /tenants
- A administração foi transferida para o MSINFOR Central
...
- rota administrativa local desativada; use o MSINFOR Central
