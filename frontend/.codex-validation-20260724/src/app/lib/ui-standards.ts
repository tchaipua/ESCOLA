...
export const UI_PATTERNS: UiPatternDefinition[] = [
    {
        ...
        summary: 'FAIXA AZUL COM BOTOES LATERAIS, LOGOTIPO DA ESCOLA, TITULO, DESCRICAO, CARD BRANCO DO USUARIO E BOTAO VOLTAR DENTRO DO BLOCO, SEM STICKY E COM `PRINCIPAL_PROFESSORES` COMO REFERENCIA VISUAL SOBERANA DO LADO DIREITO. TELAS OPERACIONAIS COM GRID PODEM USAR VARIANTE COMPACTA APROVADA EM `PRINCIPAL_FINANCEIRO_PARCELAS`, PRESERVANDO TODOS OS ELEMENTOS DENTRO DO AZUL.',
    ...
    },
    {
        ...
        summary: 'BARRA OPERACIONAL DE LISTAGEM COM ACAO DE INCLUIR NO INICIO DA LINHA DA BUSCA QUANDO EXISTIR, BOTAO COLUNAS E BOTAO DE EXPORTACAO/IMPRESSAO A ESQUERDA E SEMAFORO AO LADO DO BOTAO DE EXPORTACAO. O FINAL DO GRID DEVE FICAR SEMPRE VISIVEL, SEM ROLAGEM EXTERNA DA PAGINA; A ROLAGEM VERTICAL FICA APENAS DENTRO DA AREA DE REGISTROS. SEM TOTAIS AGREGADOS NAO USA FAIXA AZUL E MOSTRA APENAS TOTAL REGISTROS NO RODAPE; COM TOTAIS AGREGADOS USA FAIXA AZUL #1D4F91 COM ALTURA COMPACTA, TOTAL REGISTROS EM PILL BRANCO BAIXO E VALORES ALINHADOS NAS COLUNAS.',
    ...
    },
    {
        ...
        summary: 'FLUXO ADMINISTRATIVO TRANSFERIDO PARA O MSINFOR CENTRAL.',
    ...
    },
    {
        ...
        summary: 'MODULO GLOBAL TRANSFERIDO PARA O MSINFOR CENTRAL.',
