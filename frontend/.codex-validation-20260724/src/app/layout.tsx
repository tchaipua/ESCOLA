...
import SecurityFetchBootstrap from "@/app/components/security-fetch-bootstrap";
  ...
  return (
    <html lang="pt-BR">
      <body className="antialiased">
        ...
        <SecurityFetchBootstrap />
        <PwaBootstrap />
        <SystemMessageProvider><GlobalProcessingOverlay />{children}</SystemMessageProvider>
      </body>
    </html>
  );
}
