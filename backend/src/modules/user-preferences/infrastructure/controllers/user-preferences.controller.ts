...
export class UserPreferencesController {
  ...
  @Get(":key")
  @ApiOperation({ summary: "Busca uma preferência da tela para o usuário logado" })
  ...
  @Put(":key")
  @ApiOperation({ summary: "Salva ou atualiza uma preferência da tela para o usuário logado" })
  upsert(
