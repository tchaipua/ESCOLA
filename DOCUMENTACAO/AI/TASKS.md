...
- 2026-08-13: [x] E-mail cadastral normalizado em `people`: removida a cópia de
  ...
  cadastro sem CPF.
- 2026-08-14: [x] Chat privado por notificação implementado, com dupla inicial,
  convite restrito à dupla, corte de histórico para convidados, isolamento por
  escola/filial e auditoria append-only.
